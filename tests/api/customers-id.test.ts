...
describe('GET /api/customers/[id]', () => {
  ...
  it('returns a customer by id', async () => {
    mockDb.select.mockReturnValue(createMockQuery([{ id: 'cust-1', username: 'testuser', fullName: 'Test User', email: null, phone: null, routerId: 'router-1', routerName: 'Router 1', planId: 'plan-1', planName: 'Plan 1', planType: 'hotspot', status: 'active', macAddress: null, ipAddress: null, expiredAt: null, createdAt: new Date(), updatedAt: new Date() }]));
